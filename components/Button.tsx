...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "border-transparent shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 hover:shadow-md",
    secondary: "border-gray-300 text-gray-700 bg-white hover:bg-gray-50 focus:ring-indigo-500 shadow-sm",
    ghost: "border-transparent text-indigo-600 bg-transparent hover:bg-indigo-50 hover:text-indigo-700"
  };
